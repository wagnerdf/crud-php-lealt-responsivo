  ...
  <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="?i=home">Cadastrar<span class="sr-only">(página atual)</span></a>
      </li>

      <li class="nav-item active">
        <a class="nav-link" href="?i=listar">listar <span class="sr-only">(página atual)</span></a>
      </li>

      <li class="nav-item active">
        <a class="nav-link" href="?i=mensagem">Mensagem <span class="sr-only">(página atual)</span></a>
      </li>
      

    </ul>
    <form action="?i=visualizar" class="form-inline my-2 my-lg-0" name="pesquisar-user" method="GET" action="">
